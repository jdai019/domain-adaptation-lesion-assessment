...
def predict_malignancy_T2(prostate_roi,raw_image_path):
    ...
    if os.path.exists(prostate_roi):
        ...
        # print('predict_malignancy_T2 whole done!')
        return out_0_2[1][0]
...
# if __name__ == '__main__':
    ...
    # make sure the submitted files are saved under './media/upload/T2,ADC,BVAL'
    # make sure the files under './media/upload/T2,ADC,BVAL' are removed before new submission, which means only one latest file is allowed in respectice folder for each testing
