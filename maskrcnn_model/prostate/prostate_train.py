...
class ProstateDataset(utils.Dataset):
    ...
    def load_prostate(self, dataset_dir, subset):
        ...
        self.add_class("prostate", 1, "pz")
        self.add_class("prostate", 2, "cg")
       # self.add_class("prostate", 3, "cg")
       # self.add_class("prostate", 4, "prostate")
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "0.json")))
        ...
        for a in annotations:
            ...
            name=[r['region_attributes'] for r in list(a['regions'].values())]
            polygons=[r['shape_attributes'] for r in list(a['regions'].values())]
            name_dict={"pz": 1, "cg": 2}
           # name_dict = {"cap": 1, "pz": 2, "cg": 3,"prostate":4}
